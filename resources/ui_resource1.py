...
################################################################################
## Form generated from reading UI file 'untitledtSxsyo.ui'
##
...
"}\n"
"\n"
"#frame_8, #frame_9, #frame_10, #frame_11, #main_tab, #frame_12, #frame_24,  #page_square, #page_file, #page_circle, #stackedWidget_3{\n"
...
"    border: 3px solid rgb(120, 157, 186);\n"
"}\n"
"#comboBox, QTabBar::tab:!selected, QComboBox::drop-down, QComboBox::drop-arrow, QLineEdit, QSpinBox, QDoubleSpinBox, QCheckBox::indicator, QRadioButton::"
                        "indicator:!checked{\n"
"    background-color: rgba(33, 43, 51, 100);\n"
"}\n"
"\n"
...
"    height: 11px;\n"
"    width: 15px;\n"
"    image: url(:/icons/icons/arrow_down.svg) cover;\n"
"    background-color: rgba(33, 43, 51, 100);\n"
"}\n"
"\n"
...
"}")
        ...
        self.header_frame.setMaximumSize(QSize(132000, 45))
        ...
        self.main_tab.setMaximumSize(QSize(16777214, 16777214))
        self.main_tab.setToolTipDuration(29)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.main_tab), QCoreApplication.translate("MainWindow", u"\u0412\u0441\u0435", None))
    # retranslateUi

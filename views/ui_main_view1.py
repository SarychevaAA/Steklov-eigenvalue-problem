...
################################################################################
## Form generated from reading UI file 'main_viewBdSDqZ.ui'
##
...
"}")
        ...
        self.tab_widget = QFrame(self.menu_page_1)
        self.tab_widget.setObjectName(u"tab_widget")
        self.tab_widget.setEnabled(True)
        self.tab_widget.setMaximumSize(QSize(16777214, 16777215))
        self.horizontalLayout_7 = QHBoxLayout(self.tab_widget)
        self.horizontalLayout_7.setObjectName(u"horizontalLayout_7")
        self.main_tab = QWidget(self.tab_widget)
